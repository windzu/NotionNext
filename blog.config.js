...
const BLOG = {
  AUTHOR: 'windzu', // 作者
  BIO: 'cv se', // 作者简介
  LINK: 'https://blog.wind.wiki', // 网站地址
  KEYWORDS: 'Notion, blog', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '0b1d9f90467e4abca065e15c1e2b67cc', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'windzu1@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/windzu',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'windzu/blog_giscus', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOH9UuvQ', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOH9Uuvc4CRUDM', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
